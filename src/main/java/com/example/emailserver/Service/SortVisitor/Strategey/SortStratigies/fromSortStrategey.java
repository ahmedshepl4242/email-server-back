...
public class fromSortStrategey implements IStrategey {
    @Override
    public void sort(MailFolders mailFolders) {
        Queue<Mail> mailQueue = new PriorityQueue<>((mail1, mail2) -> mail2.getHeader().getFrom().toLowerCase().compareTo(mail1.getHeader().getFrom().toLowerCase()));
