...
public class BodySortStrategey implements IStrategey {
    @Override
    public void sort(MailFolders mailFolders) {
        Queue<Mail> mailQueue = new PriorityQueue<>((mail1, mail2) -> mail2.getBody().getText().toLowerCase().compareTo(mail1.getBody()
                .getText().toLowerCase()));
