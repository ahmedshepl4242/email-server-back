...
public class SubjectSortStrategey implements IStrategey {
    @Override
    public void sort(MailFolders mailFolders) {
        Queue<Mail> mailQueue = new PriorityQueue<>((mail1, mail2) -> mail2.getHeader().getSubject().toLowerCase().compareTo(mail1.getHeader().getSubject().toLowerCase()));
